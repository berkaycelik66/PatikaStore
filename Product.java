...
public class Product {
    ...
    public static void add(String nameClass) {
        try {
            ...
            if (!Brands.isThere(brand)) {     //If Brand is not on the list, Product does not add
                ...
                phoneList.add(new Phone(getPhoneCount(), price, discountRate, amount, name, brand, memory, screenSize, RAM, battery, color, camera));
